...
public class StockItemController {
    ...
    @PostMapping("/save/{id}")
    public ResponseEntity<Response> modifyItem(@PathVariable int id,@RequestBody @Valid Stock_Item stockItem) {
        return ResponseEntity.ok(
                Response.builder()
                        .timestamp(LocalDateTime.now())
                        .data(Map.of("Stock_Item", stockItemserviceImplementation.checkBeforeModify(id,stockItem)))
                        .message("stockItem saved")
                        .status(HttpStatus.OK)
                        .statusCode(HttpStatus.OK.value())
                        .build()
   ...
   /* @PostMapping("/order")
    public ResponseEntity<Response> orderStockItem(@RequestBody @Valid Stock_Item stockItem) throws IOException {
            stockItemserviceImplementation.orderStockItem(stockItem);
        return ResponseEntity.ok(
                Response.builder()
                        .timestamp(LocalDateTime.now())
                        .message("stockItem ordered")
                        .status(HttpStatus.OK)
                        .statusCode(HttpStatus.OK.value())
                        .build()
